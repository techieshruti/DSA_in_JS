...
// step 1: create a outer loop which will go from 0 to i<=n
// step 2: create a variable to store result as we need to joint the stars. if we don't store it it will print on new line.
// step 3: create a inner loop for rows it will go from 1 to j<=i, whatever the value of i, inner loop will store it into variable
